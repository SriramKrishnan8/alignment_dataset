...
awk -F"\t" '{ print $1}' $BASE/wclm.tsv > $BASE/working/word_iast.tsv
awk -F"\t" '{ print $3}' $BASE/wclm.tsv > $BASE/working/stem_iast.tsv
awk -F"\t" '{ print $5}' $BASE/wclm.tsv > $BASE/working/i_morph.tsv
awk -F"\t" '{ print $7}' $BASE/wclm.tsv > $BASE/working/base_iast.tsv
awk -F"\t" '{ print $9}' $BASE/wclm.tsv > $BASE/working/d_morph.tsv
